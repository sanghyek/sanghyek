...
<!-- 메뉴바&로그인 -->
	...
	<!-- user메뉴 -->
	<ul id="user">
	<a href="#"><li class="open-button" onclick="openForm()">로그인</li></a>
  ...
  <form action="LoginInput.jsp" class="form-container">
	...
	<a href="signin" name="signin" id="signin"> 회원가입</a>
  </form>
</div>
	<a href="Signin.html"><li>회원가입</li></a>
	</ul>
	</div>
	</nav>
	</header>
