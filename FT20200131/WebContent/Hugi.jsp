...
<!doctype html>
  <!-- CSS -->
<link rel="stylesheet" href="css/Hugi.css">
  <!-- js -->
...
ArrayList<HugiDto> list=board.List();
...
//out.print(list.size());
 ...
 for(int i=0; i<list.size(); i++){
	...
	out.print("<td width=100 align=center>"+"<label class='newimg' id='newimg"+i+"'>new</label>"+"<a href='HugiContentsView.jsp?NO="+list.get(i).getNumber()+"&hits="+list.get(i).getHits()+"'>"+list.get(i).getTitle()+"</a>"+"</td>");
	...
	out.print("<input type='hidden' id='date"+i+"' value='"+list.get(i).getDate()+"'>");//hidden타입에 value값으로 날자를 넣어 스크립트에서 비교하기
	 ...
	 ArrayList<HugiDto> list=board.List(opt,text);
	 for(int i=0; i<list.size(); i++){
	out.print("<tr>"+"<td width=100 align=center>"+list.get(i).getNumber()+"</td>");
	out.print("<td width=100 align=center>"+list.get(i).getCategory()+"</td>");
	out.print("<td width=100 align=center>"+"<a href='HugiContentsView.jsp?NO="+list.get(i).getNumber()+"&hits="+list.get(i).getHits()+"'>"+list.get(i).getTitle()+"</a>"+"</td>");
	out.print("<td width=100 align=center>"+list.get(i).getWriter()+"</td>");
	out.print("<td width=100 align=center>"+list.get(i).getDate()+"</td>");
	out.print("<td width=150 align=center>"+list.get(i).getHits()+"</td>"+"<tr>");
		 }
...
<div id="scbox">
<form name="boardsearchform" action="Hugi.jsp" onsubmit="return search()" method="post">
