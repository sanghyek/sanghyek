...
<option value="-6">바그다드Baghdad</option>
<option value="-2">방콕Bangkok</option>
<option value="-1">베이징Beijing</option>
...
<!-- 배너에시간표시 -->
<div class="clockwich"><input type="text" name="city" value="<%= request.getParameter("time")%>" readonly class="clockcheck"></div>
<!-- 도시정보상단에 도시이름표시 -->
...
<!-- 도시이름영어로 변환해서날씨폼에 입력 -->
<input type="hidden" name="dosi" id="city" value="<%=request.getParameter("Engcity")%>"></input>
<!-- 배너에날씨정보표시 -->
<div id="showWeatherForcast" value="<%=request.getParameter("wf")%>"></div>
</form>
 </div>
</div>
</div>
