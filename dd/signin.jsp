 ...
 <div id="sign_box">
  <table align="center">
	  ...
	  <td><font>*</font> E-mail</td><td>
          ...
          <select name="emailaddr" onChange=emailselect() size="1" style="width:75px;">
...
<input type="hidden" id="sample6_extraAddress" size="70" placeholder="참고항목" name="addr2"></td>
	  ...
	  <tr>
      <td><font>*</font> 아이디</td>
      <td><input type="text" name="idd" size="25" maxlength="8"> <a href='#' style='cursor:help'><button type="button" onClick=idcheck()>중복확인</button><br></a></td></tr>         
