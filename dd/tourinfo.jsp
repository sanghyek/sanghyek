...
<%@ page import="java.sql.*"%>
	...
	<title>index</title>
<link rel="stylesheet" href="css/tourinfo.css?ver=1">
...
<option value="-8">베를린Berlin</option>
<option value="-14">보고타</option>
<option value="1">브리즈번Brisbane</option>
<option value="-12">브리즈번Brisbane</option>
<option value="-7">카이로Cairo</option>
<option value="0">도쿄Tokyo</option>
