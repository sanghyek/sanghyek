...
<script  src="js/Loginheader.js"></script>
	...
	<header>
	<!--메인로고 -->
	<a href="?pageChange=tourinfo.jsp"><div id="logo"><img src="img/logo2.png"></div></a>
...
<!-- 메뉴바&로그인 -->
	...
	<div class="topMenu">
	<ul class="menu01">
		<li><a href="?pageChange=tourinfo.jsp">Home</a></li>
		<li><a href="#">항공조회</a></li>
	...
	<!-- user메뉴 -->
	<ul id="user"><a href="headerLogout.jsp">로그아웃</a>
