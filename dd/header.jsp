...
<!-- 메뉴바&로그인 -->
	...
	<ul class="menu01">
		...
		<li><a href="?pageChange=tourinfo.jsp">여행정보</a>
			<ul class="dept01">
				<li id="nop"><a href="?pageChange=tourcity.jsp">도시</a></li>
  ...
  <form action="LoginInput.jsp" class="form-container">
    <br><br><br>
	...
	<a href="srcid" name="srcid" id="srcid">아이디 찾기</a>
	<a href="srcpw" name="srcpw" id="srcpw"> 비밀번호 찾기</a>
	<a href="?pageChange=signin.jsp" name="signin" id="signin"> 회원가입</a>
  </form>
</div>
	
	<a href="?pageChange=signin.jsp"  style="color:white; opacity: 0.8;"><li>회원가입</li></a>
